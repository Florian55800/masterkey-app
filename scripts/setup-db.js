...
async function setup() {
  ...
  const migrations = [
    ...
    `ALTER TABLE "CleaningSheet" ADD COLUMN "accessCode"      TEXT`,
    `ALTER TABLE "CleaningSheet" ADD COLUMN "checkoutTime"    TEXT`,
    `ALTER TABLE "CleaningSheet" ADD COLUMN "nextCheckinTime" TEXT`,
    `ALTER TABLE "CleaningSheet" ADD COLUMN "customSections"  TEXT NOT NULL DEFAULT '[]'`,
    `CREATE TABLE IF NOT EXISTS "CleaningMargin" (
      "id"               INTEGER  NOT NULL PRIMARY KEY AUTOINCREMENT,
      "propertyId"       INTEGER  NOT NULL REFERENCES "Property"("id") ON DELETE CASCADE,
      "month"            INTEGER  NOT NULL,
      "year"             INTEGER  NOT NULL,
      "receivedPlatform" REAL     NOT NULL DEFAULT 0,
      "receivedOwner"    REAL     NOT NULL DEFAULT 0,
      "paidCleaner"      REAL     NOT NULL DEFAULT 0,
      "notes"            TEXT,
      "createdAt"        DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
      "updatedAt"        DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
